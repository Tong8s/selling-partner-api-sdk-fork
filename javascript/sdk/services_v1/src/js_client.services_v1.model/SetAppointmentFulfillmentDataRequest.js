 ...
 * @module js_client.services_v1.model/SetAppointmentFulfillmentDataRequest
 * @version v1
 */
export class SetAppointmentFulfillmentDataRequest {
   ...
   * @alias module:js_client.services_v1.model/SetAppointmentFulfillmentDataRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:js_client.services_v1.model/SetAppointmentFulfillmentDataRequest} obj Optional instance to populate.
   * @return {module:js_client.services_v1.model/SetAppointmentFulfillmentDataRequest} The populated <code>SetAppointmentFulfillmentDataRequest</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('appointmentResources'))
        obj.appointmentResources = ApiClient.convertToType(data['appointmentResources'], [AppointmentResource]);
      if (data.hasOwnProperty('fulfillmentDocuments'))
        obj.fulfillmentDocuments = ApiClient.convertToType(data['fulfillmentDocuments'], [FulfillmentDocument]);
    }
    return obj;
  }
}
...
/**
 * @member {module:js_client.services_v1.model/DateTimeRange} estimatedArrivalTime
 */
SetAppointmentFulfillmentDataRequest.prototype.estimatedArrivalTime = undefined;

/**
 * @member {module:js_client.services_v1.model/FulfillmentTime} fulfillmentTime
 */
 ...
 * @member {Array.<module:js_client.services_v1.model/AppointmentResource>} appointmentResources
 */
 ...
 * @member {Array.<module:js_client.services_v1.model/FulfillmentDocument>} fulfillmentDocuments
 */
